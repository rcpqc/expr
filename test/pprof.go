...
func main() {
	...
	// ex, _ := expr.Comp(`a==3`) // 152
	// ex, _ := expr.Comp(`a==3 || g=="123"`) // 536
	// ex, _ := expr.Comp(`!((a*b+c)/d>2)`) // 785
	// ex, _ := expr.Comp(`e.x-f[2]<3.4`) // 2164
	ex, _ := expr.Comp(`!((a*b+c)/d>2 && e.x-f[2]<3.4) || g=="123"`) // 2164
